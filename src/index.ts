...
const tools: McpToolExport['tools'] = [
  {
    name: 'list_feeds',
    description: 'List the curated feeds available (id, title, category, source). Optionally filter by category (security, health, finance, government, science, news, tech, space, sports, crypto, climate, entertainment, gaming) or keyword. Pass an id to read_feed.',
    inputSchema: {
      type: 'object',
      properties: {
        category: { type: 'string', description: 'Filter by category: security, health, finance, government, science, news, tech, space, sports, crypto, climate, entertainment, gaming.' },
