...
| Tool | Description |
|------|-------------|
| `list_feeds` | List the curated feeds available (id, title, category, source). Optionally filter by category (security, health, finance, business, government, science, ai, dev, news, tech, space, sports, crypto, climate, entertainment, gaming, automotive, food, design, energy, travel, photography, marketing, economics, books, law, transport, real-estate) or keyword. Pass an id to read_feed. |
