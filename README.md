...
| Tool | Description |
|------|-------------|
| `list_feeds` | List the curated feeds available (id, title, category, source). Optionally filter by category (security, health, finance, news, tech, space) or keyword. Pass an id to read_feed. |
